...
export class CustomToolbarComponent {
  ...
  init() {
    ...
    this.numResultsTextBase = this.toolbarModel.numResultsTextBase
      ? this.toolbarModel.numResultsTextBase
      : this.numResultsTextBaseDefault;
    ...
    this.newButtonDisabled = this.toolbarModel.newButtonDisabled
      ? this.toolbarModel.newButtonDisabled
      : false;
    ...
    this.showCalculatorIcon = this.toolbarModel.showCalculatorIcon
      ? this.toolbarModel.showCalculatorIcon
      : false;
  ...
  onClickCalculatorIcon() {
    ...
    this.customToolbarService.calculatorIconClickedSignal.set({
      value: true,
      timestamp: Date.now(),
    });
  }
