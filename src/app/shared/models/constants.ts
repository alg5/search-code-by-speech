...
export const Translations: ITranslations = {
  ...
  'header.user.dashboard': {
    ...
    ru: 'Личный кабинет',
    he: 'איזור אישי',
    fr: "Tableau de bord de l'utilisateur",
  },
  ...
  'search.title': {
    en: 'Search code of product',
    ru: 'Поиск кода продукта',
    he: 'חיפוש קוד המוצר',
    fr: 'Rechercher le code du produit',
  },
  'search.subtitle': {
    en: 'Turn on the microphone for voice search',
    ru: 'Включите микрофон для голосового поиска',
    he: 'הפעל את המיקרופון לחיפוש קולי',
    fr: 'Allumez le microphone pour la recherche vocale',
  },
  'search.subtitle2': {
    en: 'Speak now...',
    ru: 'Говорите...',
  ...
  'search.error': {
    en: 'An error occurred while searching. Please try again.',
    ru: 'Произошла ошибка при поиске. Пожалуйста, попробуйте снова.',
    he: 'אירעה שגיאה במהלך החיפוש. אנא נסה שוב.',
    fr: 'Une erreur est survenue lors de la recherche. Veuillez réessayer.',
  },
  'search.tooltip.microphone.on': {
    en: 'Turn on microphone',
    ru: 'Включить микрофон',
    he: 'הפל מיקרופון',
    fr: 'Allumer le microphone',
  },
  'search.tooltip.microphone.off': {
    en: 'Turn off microphone',
    ru: 'Выключить микрофон',
    he: 'כבה מיקרופון',
    fr: 'Éteindre le microphone',
  },
  'search.tooltip.microphone.notFound': {
    en: 'Microphone not found. Check device connection.',
    ru: 'Микрофон не найден. Проверьте подключение устройства.',
    he: 'מיקרופון לא נמצא. בדוק את חיבור המכשיר.',
    fr: "Microphone non trouvé. Vérifiez la connexion de l'appareil.",
  },
  ...
  'message.unexpectedError': {
    ...
    he: 'אירעה שגיאה בלתי צפויה. אנא נסה שוב.',
    fr: 'Une erreur inattendue est survenue. Veuillez réessayer.',
  },
  'message.error.categories.deleteHasProducts': {
    en: 'Cannot delete category because it has associated products.',
    ru: 'Невозможно удалить категорию, потому что у нее есть связанные продукты.',
    he: 'לא ניתן למחוק קטגוריה כי יש לה מוצרים משויכים.',
    fr: 'Impossible de supprimer la catégorie car elle a des produits associés.',
  },
  ...
  'message.error.processing.deleteHasProducts': {
    en: 'Cannot delete processing type because it has associated products.',
    ru: 'Невозможно удалить способ обработки, потому что у него есть связанные продукты.',
    he: 'לא ניתן למחוק סוג עיבוד כי יש לו מוצרים משויכים.',
    fr: 'Impossible de supprimer le type de traitement car il a des produits associés.',
  },
  'message.success.processing.created': {
    en: 'Processing type created successfully.',
    ru: 'Способ обработки успешно создан.',
    he: 'סוג העיבוד נוצר בהצלחה.',
    fr: 'Type de traitement créé avec succès.',
  },
  'message.success.processing.deleted': {
    en: 'Processing type deleted successfully.',
    ru: 'Способ обработки успешно удален.',
    he: 'סוג העיבוד נמחק בהצלחה.',
    fr: 'Type de traitement supprimé avec succès.',
  },
  'message.success.processing.updated': {
    en: 'Processing type updated successfully.',
    ru: 'Способ обработки успешно обновлен.',
    he: 'סוג העיבוד עודכן בהצלחה.',
    fr: 'Type de traitement mis à jour avec succès.',
  },
  ...
  'message.success.categories.deleted': {
  ...
  'caption.name.en': {
    en: 'English Name (EN)',
    ru: 'Английское название (EN)',
    he: ' (EN)שם (אנגלית)',
    fr: 'Nom anglais (EN)',
  },
  'caption.name.ru': {
    en: 'Russian Name (RU)',
    ru: 'Русское название (RU)',
    he: ' (RU)שם (רוסית)',
    fr: 'Nom russe (RU)',
  },
  'caption.name.he': {
    en: 'Hebrew Name (HE)',
    ru: 'Название на иврите (HE)',
    he: ' (HE)שם (עברית)',
    fr: 'Nom hébreu (HE)',
  },
  'caption.name.fr': {
    en: 'French Name (FR)',
    ru: 'Французское название (FR)',
    he: ' (FR)שם (צרפתית)',
    fr: 'Nom français (FR)',
  },
  ...
  'admin.processing': {
    en: 'Processing Types',
    ru: 'Способы обработки',
    he: 'סוגי עיבוד',
    fr: 'Types de traitement',
  },
  ...
  'admin.categories.confirmDelete': {
  ...
  'admin.processing.total': {
    en: 'Total Processing Types',
    ru: 'Всего способов обработки',
    he: 'סה"כ סוגי עיבוד',
    fr: 'Total types de traitement',
  },
  'admin.processing.add': {
    en: 'Add Processing Type',
    ru: 'Добавить способ обработки',
    he: 'הוסף סוג עיבוד',
    fr: 'Ajouter un type de traitement',
  },
  'admin.processing.without': {
    en: 'Without processing type',
    ru: 'Без способа обработки',
    he: 'ללא סוג עיבוד',
    fr: 'Sans type de traitement',
  },
  'admin.processing.all': {
    en: 'All processing types',
    ru: 'Все способы обработки',
    he: 'כל סוגי העיבוד',
    fr: 'Tous les types de traitement',
  },
  ...
  'admin.processing.edit': {
    en: 'Edit Processing Type',
    ru: 'Редактировать способ обработки',
    he: 'ערוך סוג עיבוד',
    fr: 'Modifier le type de traitement',
  },
  'admin.processing.delete': {
    en: 'Delete Processing Type',
    ru: 'Удалить способ обработки',
    he: 'מחק סוג עיבוד',
    fr: 'Supprimer le type de traitement',
  },
  'admin.processing.confirmDelete': {
    en: 'Are you sure you want to delete this processing type?',
    ru: 'Вы уверены, что хотите удалить этот тип обработки?',
    he: 'האם אתה בטוח שברצונך למחוק סוג עיבוד זה?',
    fr: 'Êtes-vous sûr de vouloir supprimer ce type de traitement ?',
  },
  'admin.processing.notFound': {
    en: 'No processing types found.',
    ru: 'Способы обработки не найдены.',
    he: 'לא נמצאו סוגי עיבוד.',
    fr: 'Aucun type de traitement trouvé.',
  },
  'admin.products.notFound': {
    en: 'No products found.',
    ru: 'Продукты не найдены.',
    he: 'לא נמצאו מוצרים.',
    fr: 'Aucun produit trouvé.',
  },
  'admin.categories.notFound': {
  ...
  'auth.passwordMinLength': {
    en: 'Password must be at least {requiredLength} characters long.',
    ru: 'Пароль должен быть не менее {requiredLength} символов.',
    he: 'הסיסמה חייבת להיות באורך של לפחות {requiredLength} תווים.',
    fr: 'Le mot de passe doit contenir au moins {requiredLength} caractères.',
  },
  'auth.signUpButton': {
    en: 'Create Account',
  ...
  'auth.alreadyHaveAccount': {
    ...
    ru: 'У вас есть учетная запись? Войти',
    he: 'כבר יש חשבון? התחבר',
  ...
  'auth.formInvalid': {
    ...
    he: 'אנא מלא את כל השדות הנדרשים כראוי.',
    fr: 'Veuillez remplir correctement tous les champs obligatoires.',
  },
  'auth.signUpSuccess': {
    en: 'Account created successfully! Redirecting...',
    ru: 'Учётная запись создана успешно! Переадресация...',
    he: 'החשבון נוצר בהצלחה! מועבר...',
  ...
  'auth.signUpCheckEmail': {
    ...
    ru: 'Учетная запись создана. Пожалуйста, проверьте ваш email, чтобы активировать ваш аккаунт.',
    he: 'החשבון נוצר. אנא בדוק את האימייל שלך כדי לאשר את חשבונך.',
    fr: 'Compte créé. Veuillez vérifier votre email pour confirmer votre compte.',
  },
  'auth.signInSuccess': {
    en: 'Logged in successfully! Redirecting...',
    ru: 'Регистрация в системе прошла успешно! Переадресация...',
    he: 'התחברת בהצלחה! מועבר...',
    fr: 'Connexion réussie ! Redirection...',
  },
  'auth.genericError': {
    en: 'An unexpected error occurred. Please try again.',
    ru: 'Извините, произошла неожиданная ошибка. Пожалуйста, попробуйте еще раз.',
    he: 'אירעה שגיאה בלתי צפויה. אנא נסה שוב.',
    fr: 'Une erreur inattendue est survenue. Veuillez réessayer.',
  },
