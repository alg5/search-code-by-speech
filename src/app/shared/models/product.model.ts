...
export type NewProduct = Omit<IProduct, 'id'>; // exclude 'id' since it's generated by the server on insert

export interface IProductCategory {
  id?: number; // not required when creating a new category
  code: string;
  name_en: string;
  name_ru?: string | null;
  name_he?: string | null;
...
export interface IProductProcessing {
  id?: number; // not required when creating a new processing step
  code: string;
  name_en: string;
  name_ru?: string | null;
  name_he?: string | null;
